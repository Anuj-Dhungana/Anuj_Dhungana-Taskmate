...
const Dashboard = () => {
    ...
    const handleWorkspaceClick = async (workspaceId) => {
        ...
        // Reset active project and channel when switching workspaces
        ...
        <div className="flex h-screen bg-white">
                            ...
                            <div className="space-y-1">
                                ...
                                {selectedWorkspace.projects.map((p) => (
                                    <button
                                        ...
                                        onClick={() => {
                                            setActiveProject(p);
                                            setActiveChannel(null); // Close channel if open
                                        }}
                            ...
                            <div className="space-y-1">
                                {selectedWorkspace.channels.map((c) => (
                                    <button 
                                        ...
                                        onClick={() => {
                                            setActiveChannel(c);
                                            setActiveProject(null); // Close project if open
                                        }}
                                        className={`flex items-center space-x-2 w-full px-2 py-1 rounded transition-colors
                                            ${activeChannel?._id === c._id ? 'bg-blue-600 text-white' : 'hover:bg-slate-700'}`}
                                    >
                                        <Hash size={16} />
            ...
            <div className="flex-1 bg-gray-50 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-hidden relative">
                    ...
                    {selectedWorkspace && !activeProject && !activeChannel && (
                        <div className="flex flex-col items-center justify-center h-full text-gray-400">
